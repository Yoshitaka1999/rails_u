...
ActiveRecord::Schema.define(version: 2021_07_18_135612) do

  create_table "board_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
    t.bigint "board_id"
    t.bigint "tag_id"
